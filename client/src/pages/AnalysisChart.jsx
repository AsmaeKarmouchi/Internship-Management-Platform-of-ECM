              ...
              <div className="card card-body mt-5">
                <div className="row">
                  ...
                  <div className="col-sm-4 mt-5">
                    <h5>Top 5 Entreprise</h5>
                    <hr />
                    Le graphique montre la répartition de nos étudiants à travers
                    diverses sociétés. Les 5 premières entreprises sont affichées là où
                    nos étudiants ont fait un stage.
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="card card-body mt-5">
                <div className="row mt-2">
                  <div className="col-sm-5">
                    ...
                    <hr />
                    Le diagramme circulaire suivant représente la répartition des
                    étudiants stagiaires à divers endroits tout au long des 4 années
                    au PICT.
                  </div>
                ...
                <div className="row">
                  <div className="col-sm-10 offset-1">
                    ...
                    <p style={{ textAlign: "center" }}>
                      ...
                      Le graphique ci-dessus montre le nombre d'étudiants en stage
                        À travers le temps.
                      </small>
                    </p>
                  </div>
              ...
              <div className="card card-body mt-5">
                <div className="row">
                  <div className="col-sm-4 mt-5">
                    ...
                    >
                      <h5>Répartition par division</h5>
                      <hr />
                      <a
              ...
              <div className="card card-body mt-2">
                <div className="row">
                  <div className="col-sm-10 offset-1">
                    ...
                    Répartition mensuelle des statuts de stage
                    </div>
