...
class AdminProfile extends Component {
  ...
  handleSubmit(event) {
    ...
    updatedata["firstname"] =
      formData.get("firstname") || this.state.data.firstname;
    updatedata["lastname"] =
      formData.get("lastname") || this.state.data.lastname;
              ...
              <hr />
              {
                <form id="form" onSubmit={this.handleSubmit}>
                  <div className="alert alert-info">
                    Cliquer <strong>Edit</strong> pour ajouter les détails{" "}
                    <strong>Update</strong> les informations :
                  </div>
                  <hr />
