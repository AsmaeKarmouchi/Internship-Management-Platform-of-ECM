...
class StudentProfile extends Component {
  state = {
    ...
    data: {
      ...
      currentClass: {
        year: " Promotion",
        div: " Numéro de filère",
      },
      rollNo: "NApogée",
      prevSemAttendance: "présence au semestre précédent",
      ...
      <div>
        <div className="row no-gutters">
          ...
          <div className="col-sm-10">
            ...
            <h4 className="mt-2">Mon Profile</h4>
              <hr />
              {
                <form id="form" onSubmit={this.handleSubmit}>
                  ...
                  <div className="container-fluid">
                    ...
                    <div className="form-row my-2">
                      ...
                      <div className="col-sm-6">
                      Présence au semestre précédent:
                    ...
                    <div className="form-row my-2">
                      <div className="col-sm-6">
                        ...
                        >
                          ...
                          <option disabled>filiere</option>
