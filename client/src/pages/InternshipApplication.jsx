      ...
      <div className="row no-gutters">
        ...
        <div className="col-sm-10 of">
          <div className="container-fluid">
            <h4 className="mt-2">Postuler</h4>
            <div
              className="alert alert-secondary alert-dismissible fade show"
              role="alert"
            >
              <strong>P.S. </strong> Veuillez mettre à jour votre profil avant de postuler.
              <button
                type="button"
                className="close"
                data-dismiss="alert"
            ...
            Détails du stage : 
              ...
              <div className="container-fluid">
                ...
                <div className="form-row my-2">
                  <div className="col-sm-6">
                    ...
                    <input
                      ...
                      id="internshipType"
                      className="form-control"
                      placeholder="eg. Hybride"
                      required
                    />
                  </div>

                  <div className="col-sm-6">
                  Rémunération: <span className="text-danger">*</span>
                    <div className="input-group">
                ...
                <div className="form-row my-2">
                  <div className="col-sm-6">
                    NOC requis: <span className="text-danger">*</span>
                    <input
                      type="text"
                      name="NOCRequired"
                      id="NOCRequired"
              ...
              <small className="text-danger">
                (Les fichiers doivent être téléchargés strictement au format PDF.)
              </small>
              <small className="text-primary float-right">
                (Nom du fichier : Roll_File, par exemple Ent_NOC.pdf)
              </small>
              <hr />
              <div className="container-fluid">
                <div className="form-row">
                  ...
                  Certificat de non-objection :{" "}
                    <small className="text-secondary">
                      (Téléchargez le fichier si un certificat de non-objection (NOC) est requis dans un format spécifique.)
                    </small>
                  ...
                  <div className="col-sm-6">
                  Lettre d'offre : <span className="text-danger">*</span>
                    <div className="custom-file">
                      <input
                        type="file"
                        className="custom-file-input"
              ...
              Relevés de notes :{" "}
              <small className="text-primary float-right">
              (Nom du fichier : Roll_Année, par exemple : Ent_FE.pdf)
              </small>
              <hr />
              <div className="container-fluid">
                <div className="form-row">
                  <div className="col-sm-6">
                  Relevé de notes de fin d'études (FE) :
                    <div className="custom-file">
                      <input
                        type="file"
                        className="custom-file-input"
                  ...
                  <div className="col-sm-6">
                  Relevé de notes de première année (1A) :
                    <div className="custom-file">
                      <input
                        type="file"
                        className="custom-file-input"
                ...
                <div className="form-row">
                  <div className="col-sm-6">
                  Relevé de notes de deuxième année (2A) :
                    <div className="custom-file">
                      <input
                        type="file"
                        className="custom-file-input"
                  ...
                  <div className="col-sm-6">
                  Relevé de notes de dernière année (3A) :
                    <div className="custom-file">
                      <input
                        type="file"
                        className="custom-file-input"
